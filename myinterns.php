...
$result = mysqli_query($conn,"SELECT * FROM interns_data WHERE `ManagersID` = '".$_SESSION['ID']."' ");
?>
<!DOCTYPE html>
<html>
 <head>
...
?>
<center><a href="loggedinpagemanager.php" class="btn btn-primary">All Interns</a></center>
 </body>
</html>
